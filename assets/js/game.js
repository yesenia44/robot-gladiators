...
var fight = function(enemyName) {
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        console.log(
            player + ' attacked ' + enemy.name + '. ' + enemy.name + ' now has ' + enemyHealth + ' health remaining.'
        );
        ...
        playerInfo.namehealth = Math.max(0, playerInfo.health - damage);
...
// fight each enemy robot by looping over them and fighting them one at a time
    for (var i = 0; i < enemyInfo.length; i++) {
        // if player is stil alive, keep fighting 
